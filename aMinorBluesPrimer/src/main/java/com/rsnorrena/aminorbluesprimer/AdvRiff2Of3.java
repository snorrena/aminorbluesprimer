...
public class AdvRiff2Of3 extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.advriff2of3);
	...
	public void onClick(View v) {
		...
		case R.id.bbsLeftButton:
			...
			try {
				Class<?> ourClass = Class.forName("com.rsnorrena.aminorbluesprimer.AdvRiff1Of3");
				Intent ourIntent = new Intent(AdvRiff2Of3.this, ourClass);
		...
		case R.id.bbsAudioButton:
			...
			try {
				solo = MediaPlayer.create(AdvRiff2Of3.this, R.raw.advriff2of3);
				solo.start();

			} catch (Exception e) {
				Toast.makeText(AdvRiff2Of3.this, "ERROR: audio player not working.",
		...
		case R.id.bbsVideoButton:
			...
			try {
				...
				Intent ourIntent = new Intent(AdvRiff2Of3.this, ourClass);
				ourIntent.putExtra("VideoFileName", "advriff2of3video");
				ourIntent.putExtra("ActivityName", "AdvRiff2Of3");
				ourIntent.putExtra("RiffTitle", "Advanced Riff: 2 of 3");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
		...
		case R.id.bbsRightButton:
			...
			try {
				Class<?> ourClass = Class.forName("com.rsnorrena.aminorbluesprimer.AdvRiff3Of3");
				Intent ourIntent = new Intent(AdvRiff2Of3.this, ourClass);
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
