...
public class BegRiff2Of3 extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.begriff2of3);
	...
	public void onClick(View v) {
		...
		case R.id.bbsLeftButton:
			...
			try {
				Class<?> ourClass = Class.forName("com.rsnorrena.aminorbluesprimer.BegRiff1Of3");
				Intent ourIntent = new Intent(BegRiff2Of3.this, ourClass);
		...
		case R.id.bbsAudioButton:
			...
			try {
				solo = MediaPlayer.create(BegRiff2Of3.this, R.raw.begriff2of3);
				solo.start();

			} catch (Exception e) {
				Toast.makeText(BegRiff2Of3.this, "ERROR: audio player not working.",
		...
		case R.id.bbsVideoButton:
			...
			try {
				...
				Intent ourIntent = new Intent(BegRiff2Of3.this, ourClass);
				ourIntent.putExtra("VideoFileName", "begriff2of3video");
				ourIntent.putExtra("ActivityName", "BegRiff2Of3");
				ourIntent.putExtra("RiffTitle", "Beginner Riff: 2 of 3");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
		...
		case R.id.bbsRightButton:
			...
			try {
				Class<?> ourClass = Class.forName("com.rsnorrena.aminorbluesprimer.BegRiff3Of3");
				Intent ourIntent = new Intent(BegRiff2Of3.this, ourClass);
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
