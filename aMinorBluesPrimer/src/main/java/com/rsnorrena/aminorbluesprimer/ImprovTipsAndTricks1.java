...
public class ImprovTipsAndTricks1 extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.improvtipsandtricks1);
		...
		case R.id.bmtmenubutton:
			...
			try {
				Class<?> ourClass = Class
						.forName("com.rsnorrena.aminorbluesprimer.ImprovTipsAndTricks");
				Intent ourIntent = new Intent(ImprovTipsAndTricks1.this, ourClass);
