...
public class BluesMusicTheory extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bluesmusictheory);
	...
	public void onClick(View v) {
		...
		case R.id.bmtmenubutton:
			...
			try {
				...
				Intent ourIntent = new Intent(BluesMusicTheory.this, ourClass);
