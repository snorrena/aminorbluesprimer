...
public class IntRiff1Of3 extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.intriff1of3);
	...
	public void onClick(View v) {
		...
		case R.id.bbsLeftButton:
			...
			try {
				...
				Intent ourIntent = new Intent(IntRiff1Of3.this, ourClass);
		...
		case R.id.bbsAudioButton:
			...
			try {
				solo = MediaPlayer.create(IntRiff1Of3.this, R.raw.intriff1of3);
				solo.start();

			} catch (Exception e) {
				Toast.makeText(IntRiff1Of3.this, "ERROR: audio player not working.",
		...
		case R.id.bbsVideoButton:
			...
			try {
				...
				Intent ourIntent = new Intent(IntRiff1Of3.this, ourClass);
				ourIntent.putExtra("VideoFileName", "intriff1of3video");
				ourIntent.putExtra("ActivityName", "IntRiff1Of3");
				ourIntent.putExtra("RiffTitle", "Intermediate Riff: 1 of 3");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
