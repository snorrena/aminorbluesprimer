...
public class IntRiff3Of3 extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.intriff3of3);
	...
	public void onClick(View v) {
		...
		case R.id.bbsLeftButton:
			...
			try {
				Class<?> ourClass = Class.forName("com.rsnorrena.aminorbluesprimer.IntRiff2Of3");
				Intent ourIntent = new Intent(IntRiff3Of3.this, ourClass);
		...
		case R.id.bbsAudioButton:
			...
			try {
				solo = MediaPlayer.create(IntRiff3Of3.this, R.raw.intriff3of3);
				solo.start();

			} catch (Exception e) {
				Toast.makeText(IntRiff3Of3.this, "ERROR: audio player not working.",
		...
		case R.id.bbsVideoButton:
			...
			try {
				...
				Intent ourIntent = new Intent(IntRiff3Of3.this, ourClass);
				ourIntent.putExtra("VideoFileName", "intriff3of3video");
				ourIntent.putExtra("ActivityName", "IntRiff3Of3");
				ourIntent.putExtra("RiffTitle", "Intermediate Riff: 3 of 3");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
		...
		case R.id.bbsRightButton:
			...
			try {
				...
				Intent ourIntent = new Intent(IntRiff3Of3.this, ourClass);
				ourIntent.putExtra("ActivityName", "IntRiff3Of3");
				ourIntent.putExtra("SoloTitle", "Intermediate Blues Solo");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
