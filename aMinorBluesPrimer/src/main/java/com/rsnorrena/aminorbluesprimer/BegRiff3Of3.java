...
public class BegRiff3Of3 extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.begriff3of3);
	...
	public void onClick(View v) {
		...
		case R.id.bbsLeftButton:
			...
			try {
				...
				Intent ourIntent = new Intent(BegRiff3Of3.this, ourClass);
		...
		case R.id.bbsAudioButton:
			...
			try {
				solo = MediaPlayer.create(BegRiff3Of3.this, R.raw.begriff3of3);
				solo.start();

			} catch (Exception e) {
				Toast.makeText(BegRiff3Of3.this, "ERROR: audio player not working.",
		...
		case R.id.bbsVideoButton:
			...
			try {
				...
				Intent ourIntent = new Intent(BegRiff3Of3.this, ourClass);
				ourIntent.putExtra("VideoFileName", "begriff3of3video");
				ourIntent.putExtra("ActivityName", "BegRiff3Of3");
				ourIntent.putExtra("RiffTitle", "Beginner Riff: 3 of 3");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
		...
		case R.id.bbsRightButton:
			...
			try {
				...
				Intent ourIntent = new Intent(BegRiff3Of3.this, ourClass);
				ourIntent.putExtra("ActivityName", "BegRiff3Of3");
				ourIntent.putExtra("SoloTitle", "Beginner Blues Solo");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
