...
public class AdvRiff1Of3 extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.advriff1of3);
	...
	public void onClick(View v) {
		...
		case R.id.bbsLeftButton:
			...
			try {
				...
				Intent ourIntent = new Intent(AdvRiff1Of3.this, ourClass);
		...
		case R.id.bbsAudioButton:
			...
			try {
				solo = MediaPlayer.create(AdvRiff1Of3.this, R.raw.advriff1of3);
				solo.start();

			} catch (Exception e) {
				Toast.makeText(AdvRiff1Of3.this, "ERROR: audio player not working.",
		...
		case R.id.bbsVideoButton:
			...
			try {
				...
				Intent ourIntent = new Intent(AdvRiff1Of3.this, ourClass);
				ourIntent.putExtra("VideoFileName", "advriff1of3video");
				ourIntent.putExtra("ActivityName", "AdvRiff1Of3");
				ourIntent.putExtra("RiffTitle", "Advanced Riff: 1 of 3");
				startActivity(ourIntent);
				finish();
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
